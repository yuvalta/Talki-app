...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, "ca-app-pub-8337271880027338~4921587212");
        interstitialAd = new InterstitialAd(this);
        interstitialAd.setAdUnitId("ca-app-pub-8337271880027338/6473276377");
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        ...
                        if (menuItem.getItemId() == R.id.tutorialAgain) { // load tutorial again
    ...
    public void showsTheMessageOnScreen(View view, CustomDialog previousDialog) {
        counterTillAdsDisplay++;
        allAction[0] = String.valueOf(counterTillAdsDisplay); // counter of ads - save in allaction shared preferences
    ...
    public void closeMessage(View view) {
        if (counterTillAdsDisplay == 3 && interstitialAd.isLoaded()) {
            counterTillAdsDisplay = 0;
            interstitialAd.show();
        }
        prefixOne.setVisibility(View.VISIBLE);
        prefixTwo.setVisibility(View.VISIBLE);
